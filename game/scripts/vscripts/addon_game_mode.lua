...
--[[
  ...
  See CustomHeroes:PostLoadPrecache() in gamemode.lua for more information
  ]]

  DebugPrint("[CUSTOMHEROES] Performing pre-load precache")
...
function Activate()
  --GameRules.CustomHeroes = CustomHeroes()
  --GameRules.CustomHeroes:_InitCustomHeroes()
end
