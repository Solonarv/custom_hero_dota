...
--[[
  ...
  -Ensure that you have the customheroes_notifications.xml, customheroes_notifications.js, and customheroes_notifications.css files in your panorama content folder.
  -Ensure that customheroes_notifications.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/customheroes_notifications.xml" />
