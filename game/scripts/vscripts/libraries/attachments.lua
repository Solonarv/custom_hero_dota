...
--[[
  ...
  -Ensure that you have the customheroes_attachments.xml, customheroes_attachments.js, and customheroes_attachments.css files in your panorama content folder to use the GUI.
  -Ensure that customheroes_attachments.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/customheroes_attachments.xml" />
