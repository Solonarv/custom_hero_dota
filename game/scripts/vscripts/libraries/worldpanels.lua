...
--[[
  ...
  -Ensure that you have the customheroes_worldpanels.xml in your panorama content layout folder.
  -Ensure that you have the customheroes_worldpanels.js in your panorama content scripts folder.
  -Ensure that customheroes_worldpanels.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/customheroes_worldpanels.xml" />
